...
class BreadcrumbsUtility {     
    /**      * @param $links array breadcrumbs links (yii\widgets\Breadcrumbs Public property links)      * @param int $home start breadcrumbs links (if isset home, $home=2. If not isset home, $home=1)      * @return array breadcrumbs links      */     
    ...
    /**      * @param $label string name home label      * @param $url string url link home page      * @return array      */     
    ...
    /**      * @param $label      * @param $url      * @param $key      * @return string template microdata      */    
