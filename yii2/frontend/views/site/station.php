...
$this->title="Остановка ".$station->name.$info." в ".$city_s[5]." | ".$tte_n;

$descr="Маршруты ".$tte_o.$tte_n." через остановку ".$station->name." в городе ".$city_s[0].". Как проехать, направление и время отправления.";
...
<div class="city-top">
        ...
        <h1 class="subtitle">Маршруты общественного транспорта через остановку "<?=$station->name;?>"</h1>
...
<? ////////////////////////////////////////////////////////////////////////////////?>
    <?= Breadcrumbs::widget([
        ...
        <div class="route-map">
            <a href="#map" id="showmap" idr="<?=$station->id;?>"><div class="map_bg">Остановка на карте</div></a>
        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?=Url::toRoute(['site/route', 'id' => $r['id']]);?>">
                                    <span class='level'><?=$r['number'];?></span>
                                    <span class="value"><?=$r['name']?></span></a>
                                    <? if (isset($route[0])) {
